...
$(function () {
    ...
    //form submit
    $('#userUpdateSbmitBtn').on('click', function(e) {
    ...
    // Add event for counting characters for user name
    updateUNameCount();
    ...
    // Add event for counting characters for address
    updateAddressCount();
...
function updateFNameCount() {
    const maxLength = 50;
    const currentLength = $('#firatName').val().length;
    const remainingCharacters = maxLength - currentLength;
    $('#firatNamecharCount').text(remainingCharacters + " characters left");
}


function updateLNameCount() {
    const maxLength = 50;
    const currentLength = $('#LastName').val().length;
    const remainingCharacters = maxLength - currentLength;
    $('#lastNamecharCount').text(remainingCharacters + " characters left");
}


function updateEmailCount() {
    const maxLength = 50;
    const currentLength = $('#userEmail').val().length;
    const remainingCharacters = maxLength - currentLength;
    $('#userEmailCount').text(remainingCharacters + " characters left");
}


function updateUNameCount() {
    const maxLength = 50;
    const currentLength = $('#userName').val().length;
    const remainingCharacters = maxLength - currentLength;
    $('#userNameCount').text(remainingCharacters + " characters left");
}


function updateAddressCount() {
    const maxLength = 200;
    const currentLength = $('#address').val().length;
    const remainingCharacters = maxLength - currentLength;
    $('#addressCount').text(remainingCharacters + " characters left");
}
